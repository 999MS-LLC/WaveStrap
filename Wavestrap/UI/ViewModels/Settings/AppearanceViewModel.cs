...
using Wavestrap.UI.Elements.Settings;
using Wavestrap.UI.Elements.Editor;
using Wavestrap.UI.Elements.Dialogs;

namespace Wavestrap.UI.ViewModels.Settings
{
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconWavestrap;
                }
                else
                {
