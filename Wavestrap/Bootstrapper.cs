...
using Wavestrap.AppData;
using Wavestrap.RobloxInterfaces;
using Wavestrap.UI.Elements.Bootstrapper.Base;
...
namespace Wavestrap
{
    public class Bootstrapper
    {
        ...
        public string MutexName { get; set; } = "Wavestrap-Bootstrapper";
        ...
        public async Task Run()
        {
            ...
            if (!_noConnection)
            {
                ...
                {
                    bool backgroundUpdaterMutexOpen = Utilities.DoesMutexExist("Wavestrap-BackgroundUpdater");
        ...
        private static void LaunchMultiInstanceWatcher()
        {
            ...
            using EventWaitHandle initEventHandle = new EventWaitHandle(false, EventResetMode.AutoReset, "Wavestrap-MultiInstanceWatcherInitialisationFinished");
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Wavestrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingWavestrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Wavestrap.exe");
        ...
        private static void StartBackgroundUpdater()
        {
            ...
            if (Utilities.DoesMutexExist("Wavestrap-BackgroundUpdater"))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://github.com/GodsWave-LLC/Wavestrap/wiki/Wavestrap-is-unable-to-download-Roblox](https://github.com/GodsWave-LLC/Wavestrap/wiki/Wavestrap-is-unable-to-download-Roblox)"),
