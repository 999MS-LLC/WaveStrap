...
using Wavestrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Wavestrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Wavestraprpc, discord rich presence, or game history
