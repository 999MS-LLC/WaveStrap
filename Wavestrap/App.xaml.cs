...
namespace Wavestrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Wavestrap-QA";
#else
        public const string ProjectName = "Wavestrap";
#endif
        public const string ProjectOwner = "Wavestrap";
        public const string ProjectRepository = "GodsWave-LLC/Wavestrap";
        public const string ProjectDownloadLink = "https://godswavellc.pages.dev/Wavestrap";
        public const string ProjectHelpLink = "https://github.com/GodsWave-LLC/Wavestrap/wiki";
        public const string ProjectSupportLink = "https://github.com/GodsWave-LLC/Wavestrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructWavestrapWebUrl();
        ...
        public static string ConstructWavestrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "godswavellc.pages.dev/Wavestrap";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"web-{sub}.godswavellc.pages.dev";
        }
