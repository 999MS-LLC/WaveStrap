...
namespace Wavestrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconWavestrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconWavestrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconWavestrap => Properties.Resources.IconWavestrap,
                ...
                BootstrapperIcon.IconWavestrapClassic => Properties.Resources.IconWavestrapClassic,
                _ => Properties.Resources.IconWavestrap
            };
        }
    }
}
